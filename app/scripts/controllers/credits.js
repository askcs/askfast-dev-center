define(["require", "exports", './controllers'], function (require, exports, controllers) {
    'use strict';
    var creditsController = controllers.controller('credits', function ($scope, $rootScope, $routeParams, $timeout, $location, $filter, AskFast, Session, Store, DTOptionsBuilder, DTColumnDefBuilder) {
